...
export default function AoAnalyzerClient() {
  ...
  async function runAnalysis() {
    ...
    try {
      const res = await fetch('/api/free-tools/analyze', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ url: trimmed, type: 'ao' }),
      })
    ...
    <div className="min-h-screen bg-[#FDFAF6] text-[#1C1917]">
      ...
      <section className="bg-[#F7F3EC] px-6 py-20">
        <div className="max-w-5xl mx-auto">
          <h2
            style={playfair}
            className="text-3xl sm:text-4xl font-bold text-center text-[#1C1917] mb-14"
          >
            How It Works
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {[
              ...
              {
                num: '02',
                heading: 'Score 6 AO factors',
                body: 'We check question-based headings, featured snippet format, FAQ sections, scannable structure, conversational language, and related question coverage.',
              },
              {
                num: '03',
      ...
      <section className="bg-[#F7F3EC] px-6 py-20">
        <div className="max-w-2xl mx-auto">
          ...
          >
            What is Answer Optimization (AO)?
          </h2>
          <div className="space-y-4 text-[#57534E] text-[17px] leading-relaxed mb-12">
            ...
            <p>
              ...
              targets, uses question-based headings that mirror how people phrase their searches,
              and covers related follow-up questions that come naturally after the main topic. These
              patterns make it easy for search engines and AI models to extract the exact answer
              a user needs.
            </p>
          </div>
      ...
      <section className="bg-[#1C1917] px-6 py-24 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            <Link
              href="/signup?plan=free&ref=ao_analyzer"
      ...
      <footer className="bg-[#1C1917] border-t border-white/10 px-6 py-10">
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-[#A89070]">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6">
            ...
            <Link href="/pricing" className="hover:text-[#F7F3EC] transition-colors">
              Pricing
            </Link>
            <Link href="/login" className="hover:text-[#F7F3EC] transition-colors">
              Login
            </Link>
          </div>
        </div>
