...
import { Search, Plus, ChevronRight, Loader2, AlertCircle, CheckCircle2, Clock } from 'lucide-react'
...
export default function KeywordsPage() {
  ...
  async function handleCreate(e: React.FormEvent) {
    ...
    const { data, error } = await (supabase as any)
      .from('keyword_projects')
      .insert({ user_id: user.id, name, seed_topic: seedTopic, status: 'pending' })
      .select('id')
      .single()
  ...
  return (
    <div className="p-8 max-w-3xl">
      <div className="flex items-center justify-between mb-8">
        ...
        <button
          onClick={() => { setShowForm(true); setName(''); setSeedTopic('') }}
